...
main ()
{
  ...
  apt_config_url="https://packagecloud.io/install/repositories/pufferpanel/pufferpanel/config_file.list?os=any&dist=any&source=script"

  apt_source_path="/etc/apt/sources.list.d/pufferpanel_pufferpanel_any.list"
  ...
  gpg_keyring_path="$apt_keyrings_dir/pufferpanel_pufferpanel-archive-keyring.gpg"
    gpg_key_path_old="/etc/apt/trusted.gpg.d/pufferpanel_pufferpanel_any.gpg"
